...
- **`WORKFLOW.md`** — end-to-end pipeline rationale and task-oriented operating
  guide. Do not copy the package tree or full CLI inventory into it: the source
  tree and executable `--help` are canonical and cannot drift.
